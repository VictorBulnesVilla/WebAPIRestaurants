...
namespace WebAPIRestaurants.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class RestaurantsController : ControllerBase
    {
        private readonly WebAPIRestaurantsContext _context;

        public RestaurantsController(WebAPIRestaurantsContext context)
        {
            _context = context;
        }
